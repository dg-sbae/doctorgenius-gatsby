...
const heroConfig = {
  ...
  strapline: "Px Experience",
  title: [<span>Px </span>, " Experience"],
  content: "px experience px experience.",
}

const PxExperience = data => {
...
export default PxExperience

export const ImageQuery = graphql`
  query PxExperienceImages {
