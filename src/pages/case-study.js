              ...
              <div className="col-sm-12 col-md-10 col-lap-6 col-lg-6">
                <div className="">
                  <p>
                    ...
                    any organic traffic related to online search was
              ...
              <div className="col-sm-12 col-md-10 order-2 col-lap-6 order-lap-1 col-lg-6 order-lg-1">
                <div className="">
                  <p>
                    ...
                    practice’s ever important social profiles. Focus on customer
                    satisfaction and increasing his positive online reputation.
                    Persistent and never-ending content publishing to rise above
                    his competitors in the online ranking battle.
                    <br />
                    <br />
                  ...
                  <div className="col-sm-12 col-md-6 panel-quad-item">
                    ...
                    <div className="panel-quad-text-block">
                      ...
                      <p>
                        ...
                        the 6 months we were able to increased new quality
                  ...
                  <div className="col-sm-12 col-md-6 panel-quad-item">
                    ...
                    <div className="panel-quad-text-block">
                      ...
                      <p>
                        ...
                        our proud to have all our product inhouse for our
                        clients needs.
                      </p>
                    </div>
                  </div>
                ...
                <div className="row">
                  <div className="col-sm-12 col-md-6 panel-quad-item">
                    ...
                    <div className="panel-quad-text-block">
                      ...
                      <p>
                        ...
                        are happy. We provide seamless support by taking the
                        time to understand our clients concerns in areas they
                        need help.
                      </p>
                    </div>
                  </div>
                  <div className="col-sm-12 col-md-6 panel-quad-item">
                    ...
                    <div className="panel-quad-text-block">
                      ...
                      <p>
                        We are driven to improve our clients marketing
                        preformance in all areas. Our technology has proven for
                        the first 6 months we are guranteed our clients 200% new
                        patients inquire.
                      </p>
                    </div>
                  </div>
