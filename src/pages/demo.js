            ...
            <div className="valign-wrapper row">
              <div className="col-md-10 order-md-1 col-lg-8 order-lg-1 float-lg-left">
                ...
                <p className="disappear">
                  ...
                  and retention? Sign up for our demo to learn how you can have
                      ...
                      <div className="inner-title">
                        ...
                        <div className="accented-paragraph">
                          <p>
                            ...
                            practice to the next level. Our tiers have unique
                            plan features to meet your practice needs.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="body">
                    ...
                    <div className="content">
                      <p>
                        ...
                        with more phone calls that were referred from online and
                        SEO marketing (more so within last one year).
                        ...
                        considering to upgrade my marketing plan with them to a
                        more premium plan (Gold or Platinum).
                      </p>
                  ...
                  <div className="body">
                    ...
                    <div className="content">
                      <p>
                        ...
                        offices over the course of 8 years. If that doesn't tell
                        you that their program works, I don't know what will.
                        Francesco has great customer service and follows up
                        throughout the set up to make sure things are going
                        well. If I ever have issues, I can contact him or email
                        their customer support team and my questions or website
                      ...
                      <p>
                        ...
                        signing. Your "online" phone number will change for
                        their tracking purposes, you'll have a little recorded
                        message at the beginning of patient calls saying that
                        call will be recorded, and your website will have copy
                        and pasted material as another reviewer said. But that
                        matters little when the new patients call after having
                        been engaged on your website.
                      </p>

                      <p>
                        We have been consistently getting heavy web traffic
                        (this is tracked and they'll show you the metrics -- it'
                        not just a verbal monthly follow up like I had
                        previously had with SEO companies), and more new
                        patients since the website launched. We are getting what
                        we paid for, and will continue to utilize their
                        services. They are up to date on all the google
                        algorithms, and gave us ideas to keep the "freshness" up
                        on our website, our google business listing and social
                        media. I highly recommend their services!
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="body">
                    ...
                    <div className="content">
                      <p>
                        ...
                        really liked about them was they were not trying to push
                        their most expensive package, in fact they were
                        stressing to start with the basics and upgrade gradually
                        as I grow. Whenever I have a question, if I send an
                        email I always get an immediate call back from
                        Francesco, which I find amazing as most other companies
                        I work with take days to respond if at all. Most of the
                        website work has been with Shanyn who has also been
                        great. She is responsive and listens to my suggestions.
                        I have the blogs set so I can review them before they go
                        up which I like because I like to have my own spin put
                        in as well. I recently upgraded to the Gold package and
                        I am looking forward to seeing how much more business we
                        get!!
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="body">
                    ...
                    <div className="content">
                      <p>
                        ...
                        specifically with Dartangnan Johnson and my experience
                        so far has been nothing but stellar! We had a lot of
                        turnover with our marketing the last 1-2 years, and were
                        struggling to find a team who really understood our
                        needs and expectations. We really hit it out of the park
                        being connected to Dartangan and Doctor Genius, because
                        their experience and knowledge with Google is what sets
                        them apart from other marketers. The resources provided
                        to clients are wonderful tools to stay on top of your
                  ...
                  <div className="body">
                    ...
                    <div className="content">
                      <p>
                        ...
                        and can honestly say this is by far, the BEST team to
                        have by your side. Besides increasing our numbers, they
                        have always put our needs and wants first. Doctor Genius
                        has educated us through out our entire journey together
                        and we are a better company because of it. A special
                        recognition goes to Mr. Shawn S. who has gone above and
                        beyond for us and helped us see the light at the end of
                        a dark,dark tunnel. And for that, Thank you Shawn for
                        helping us show the world who we are. Blessings!
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="body">
                    ...
                    <div className="content">
                      <p>
                        ...
                        doubled as a result. They're always available to talk if
                        you have any issues or questions. Two thumbs up!! Just
                        ask for Francesco, he's my account manager and he'll
                  ...
                  <div className="body">
                    ...
                    <div className="content">
                      <p>
                        ...
                        They told me it would take 3-4 months to see results.
                        Its been about 2 now that my google presence has been
                        cleaned up and my website is up and running and I am
                        starting to see people come in the door who found us
                        solely on google.
                      </p>
                      ...
                      <p>
                        ...
                        was the first person I worked with and he is wonderful.
                        He really took the time to explain everything. Although
                        it is early in the process, what he said would happen
                        after cleaning up our internet presence is starting to
                        unfold. I have also worked with Brandon, Shawn,
                        Victoria, and Kylie, all of which have been a pleasure
                        to work with.
                      </p>
                    </div>
                  </div>
              ...
              <div className="col-sm-12 col-md-10 col-lg-12">
                <div className="review">
                  ...
                  <div className="body">
                    ...
                    <div className="content">
                      <p>
                        Doctor Genius was a game changer for our office, we saw
                        a SIGNIFICANT increase in new patient counts and online
                        search results. We doubled our new patient counts within
                        a few months of starting with Doctor Genius, with half
                        of the credit due to their online optimization and
                        service. Shawn Stiffler has been an excellent guiding
                        force as we ramped up this service and when we decided
                        to upgrade the service after one year with them. Thank
                        you! Krista
                      </p>
                    </div>
                  </div>
