            ...
            <div className="row padded tall-top short-bottom">
              <div class="col-sm-12 col-md-8">
                <p>
                  ...
                  (this “Policy”) applies to the use of all Practice AI services
                  offered by Company (sometimes herein referred to as “Doctor
                  Genius” or “we” or “our” or “us”) used by Customer (sometimes
                  herein referred to as “you” or “your”). It is and incorporated
                  into the Agreement (as defined in the Terms of Service
                  accessible at
                ...
                <p>
                  ...
                  exhaustive. WE RESERVE FULL AND FINAL DISCRETION AS TO WHETHER
                  CERTAIN USES VIOLATE THIS POLICY. YOU AGREE THAT OUR
                  ...
                  <ol>
                    <li>
                      ...
                      <ol className="alpha-list">
                        ...
                        <li>
                          ...
                          (or SMS) enabled, or both, and that you possess to the
                          necessary equipment and software to receive and
                    ...
                    <li>
                      ...
                      <ol className="alpha-list">
                        ...
                        <li>
                          ...
                          You agree not to use the PAI Service to create,
                          receive, maintain, or transmit protected health
                          information, as defined in the BAA, and to use the PAI
                          Service only as permitted by the BAA.
                        </li>
                      </ol>
                    </li>
                    <li>
                        ...
                        <li>
                          ...
                          <ul>
                            ...
                            <li>
                              ...
                              information, including the email addresses of any
                              person without such person’s knowing and continued
                            ...
                            <li>
                              sending unsolicited emails to significant numbers
                              of email addresses belonging to individuals and/or
                    ...
                    <li>
                      ...
                      <ol className="alpha-list">
                        ...
                        <li>
                          ...
                          inaccurate, or that a reasonable person could deem to
                          be objectionable, profane, indecent, pornographic,
                          harassing, threatening, embarrassing, hateful, or
                          otherwise inappropriate; or
                        </li>
                        <li>
                          Perform any fraudulent activity, including
                          impersonating any person or entity or claiming a false
                          affiliation; misrepresenting the source, identity or
                          content of information transmitted via the PAI Service
                        </li>
                      </ol>
                    </li>
                    <li>
                      ...
                      <p>
                        We reserve the right, but do not assume the obligation,
                        to investigate any violation of this Policy or misuse of
                        the PAI Service. We may:
                      </p>
                      <ol className="alpha-list">
                        <li>
                        ...
                        <li>
                          ...
                          regulators, or other appropriate third parties to help
                          with the investigation and prosecution of illegal
                          conduct by providing network and systems information
                          related to alleged violations of this Policy.
                        </li>
                      </ol>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <p>
                        ...
                        you must (a) comply with any notices received under
                        Title II of the Digital Millennium Copyright Act of 1998
                        (Section 512 of the U.S. Copyright Act) or similar
                        statute in other countries (the “DMCA”), (b) set up a
                        process to expeditiously respond to notices of alleged
                        infringement that comply with the DMCA and to implement
                        a DMCA‐compliant repeat infringers policy, (c) publicly
                        display a description of its notice and takedown process
                        under the DMCA on its instance of the services, and (iv)
                        comply with such processes, policy(ies), and
                        description.
                      </p>
                      <p>
                        It is our policy to respond expeditiously to valid
                        notices of claimed copyright infringement compliant with
                        the DMCA. In appropriate circumstances, we may terminate
                        your use of the PAI Service due to repeatedly or
                        blatantly copyright infringement.
                      </p>
                      <p>
                        ...
                        of the PAI Service and/or remove the allegedly
                        infringing material. If we receive more than one such
                        notice, we reserve the right to immediately terminate
                        your subscriptions to the PAI Service as deemed
                        necessary by us to ensure continued protection under the
                        safe harbor provisions under the DMCA or to prevent
                        violations of other applicable laws or third parties’
                        rights.
                      </p>
                    </li>
                  </ol>
