...
<style>
    ...
    .cta .card { padding-top: 20px;display: block;position: relative;top: -115px;border-radius:5px; }
...
<style type='text/css'>
    ...
    @media only screen and (max-width : 601px) {
        ...
        .embeddedServiceHelpButton .helpButton .uiButton { height:60px;padding:0 18px 0 15px;border-radius: 50px 0 20px 0;font-size:22px; }
        .embeddedServiceHelpButton .uiButton .helpButtonLabel { display:none; }
        .embeddedServiceHelpButton .embeddedServiceIcon { margin-right: 0px;margin-top: 10px;margin-left: 0px; }
