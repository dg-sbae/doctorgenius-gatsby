...
<body>
 ...
 <div id="Blog">
      <div id="Hero">
         <div class="container">
            <div class="row">
               <div class="col s12 m12 l12 hero"><a href="/blog/"><img src="/wp-content/uploads/2016/08/hero-01-image.jpg" class="z-depth-1" title="image" alt="image"></a></div>
            </div>
         </div>
      </div>   
         ...
         <div class="container">
            <div class="row">
              <div class="slider">
                <ul class="slides">
                  <li>
                    <a href="/learn-basic-seo/"><img src="/wp-content/uploads/2016/08/trend-01-image.jpg" alt="image"></a>
                    <div class="caption center-align">
                      <a href="/learn-basic-seo/"><h3>Learn the Basic Components of SEO</h3></a>
                    </div>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/call-tracking-seo/"><img src="/wp-content/uploads/2016/08/trend-03-image.jpg"></a>
                    <div class="caption right-align">
                      <a href="/call-tracking-seo/"><h3>What You Should Know About Call Tracking and SEO</h3></a>
                    </div>
                  </li>
                  <li>
                    <a href="/local-search-rise/"><img src="/wp-content/uploads/2016/08/trend-04-image.jpg"></a>
                    <div class="caption center-align">
                      <a href="/local-search-rise/"><h3>Local Searches Are on the Rise</h3></a>
                    </div>
                  </li>
                </ul>
              </div>
   ...
   <div class="container pad-25">
      <div class="row">
                                      ...
                                      <div class="col s6 m6 l7">
                                             ...
                                             <div class="post-social">
                                                <ul>
                                                   ...
                                                   <li class="waves-effect waves-light"><a href="https://twitter.com/hashtag/dentalgenius"><img src="/wp-content/uploads/2016/08/icon-social-twitter.png" title="twitter" alt="twitter"></a></li>
                                                   <li class="waves-effect waves-light"><a href="https://plus.google.com/+Dentalseosites"><img src="/wp-content/uploads/2016/08/icon-social-googleplus.png" title="google plus" alt="google plus"></a></li>                                                   
                                                   <li class="waves-effect waves-light"><a href="https://www.youtube.com/channel/UC45xhqBrSlGgB0VAMr5Z0hQ"><img src="/wp-content/uploads/2016/08/icon-social-youtube.png" title="youtube" alt="youtube"></a></li>                                                   <!-- <li class="waves-effect waves-light"><img src="/wp-content/uploads/2016/08/icon-social-pinterest.png" title="pinterest" alt="pinterest"></li> -->
                                                   <!-- <li class="waves-effect waves-light"><img src="/wp-content/uploads/2016/08/icon-social-link.png" tile="share" alt="share"></li> -->
                                                </ul>
                                             </div>               
                                       </div>
                                   </div>
         ...
         <div id="SideBar" class="col s12 m4 l4">
            ...
            <div class="row">
             <div class="ad-image waves-effect waves-light"><a href="/demo/" target="_blank"><img src="/wp-content/uploads/2016/08/ad-image-01.jpg" alt="ads" title="ads"></a></div>
            </div>
      ...
      <script type="text/javascript" src="/doctor-genius/assests/js/materialize.min.js"></script>
